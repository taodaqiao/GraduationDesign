#ifndef _H_KERNEL_STRUCT_DEFINE_H
#define _H_KERNEL_STRUCT_DEFINE_H
#include <fltKernel.h>
...
#pragma pop(pop)//设定为4字节对齐
	...
	typedef struct _EJOB                                // 42 elements, 0x1C8 bytes (sizeof)
	{
		...
		/*0x1A8*/     UINT64		MemoryLimitsLock;          // 7 elements, 0x8 bytes (sizeof)  modify
	...
	{
		/*0x000*/     UINT64		WorkingSetMutex;        // 7 elements, 0x8 bytes (sizeof)
	...
	{
		/*0x000*/     UINT64	Lock;        // 7 elements, 0x8 bytes (sizeof)
...
#pragma pack(pop)//恢复对齐状态
	...
	typedef struct _ETHREAD                                              // 88 elements, 0x498 bytes (sizeof)
	{
		...
		/*0x438*/     UINT64		ThreadLock;                                 // 7 elements, 0x8 bytes (sizeof)
	...
	typedef struct _EPROCESS_S                                               // 135 elements, 0x4D0 bytes (sizeof)
	{
		...
		/*0x160*/     UINT64 ProcessLock;                                  // 7 elements, 0x8 bytes (sizeof)  modify
		...
		/*0x218*/	  UINT64  AddressCreationLock;                          // 7 elements, 0x8 bytes (sizeof)
